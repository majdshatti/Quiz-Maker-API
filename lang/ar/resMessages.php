...
return [
    "alreadyVerfied" => "تم التحقق من الحساب بالفعل !!.",
    "authenticate" => "غير مصدق بالوصول إلى هذاالمسار.",
    "authorize" => "غير مصرح بالوصول إلى هذاالمسار.",
    "badRequest" => "طلب غير صالح",
    "codeSent" => "تم إرسال رمز إعادة تعيين كلمة المرور.",
    "created" => ":path تم إنشاء بنجاح",
    "creds" => "بيانات دخول غير صحيحة",
    "deleted" => ":path تم الحذف بنجاح",
    "edited" => ":path تم التعديل بنجاح",
    "falseAnswers" => "جميع الإجابات على نفس السؤال خاطئة.",
    "forbbiden" => "محظور",
